...
| 非公開1,440値から24時間集計 | Aggregate Validation、Device所有History | 選択可能なJST 2日、選択日ごとに1,440件と時間別Rowが正確に24件 |
...
| Public検証／Privacy | ConfirmedかつTX ID／Hash／Block完備のみの最新順Redacted API、正しいWITHIN／OUTSIDE、Private Field拒否 | WITHIN／OUTSIDE／STOPPED最新順一覧、Indexer進捗、4 Check、5 Stage、Explorer Link、Raw値Mask、Private Sentinel非表示 |
