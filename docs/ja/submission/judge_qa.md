...
2026-08-31の現行ソースで、6つの証明回路のコンパイル、288件の自動テスト、型検査、ビルド、Cloudflare配備前検査に成功しています。Midnight事前公開ネットワークには、2026-08-28の自己負担WITHIN／OUTSIDEと2026-08-30のSponsor負担Schema-5記録があります。ソース検証と日付付きネットワーク記録は別のEvidenceです。
