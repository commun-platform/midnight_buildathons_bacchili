...
| 1,440 private readings to 24 hourly summaries | Aggregate validation and Device-owned history tests | Two selectable operational days; 1,440 readings and exactly 24 rendered hourly rows per selected day |
