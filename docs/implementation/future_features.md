...
| `FF-O11` | P0 | Audit, diagnostics, and operations dashboard | Logs and processing state exist primarily for development and review. | Security-sensitive actions have an audit trail; structured redacted logs, metrics, health, queue depth, retry state, alerting, and recovery controls are visible to authorized system operators. |
