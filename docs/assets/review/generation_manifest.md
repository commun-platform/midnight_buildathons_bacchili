...
- Edge Device keeps sensor values and signing keys; Frontend holds no Device credential; Backend handles public workflow storage and proof generation; Midnight records the operational period/boundary, 24 hourly results, public threshold/validity, and target Device Commitment.
...
- Mark raw values and hourly minimum/maximum private, and operational date/boundary / 24 hourly statuses / count / specification version / threshold/validity / Device Commitment / signed transaction public.
...
- Public: operational date/boundary, 24 hourly results, threshold/validity, Device Commitment, and Midnight transaction record.
