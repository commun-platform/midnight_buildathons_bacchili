...
const tableSpecs = [
  ...
  },
  {
    ...
    columns: [
      ...
      'assignment_id', 'assignment_key', 'hour_presence', 'hour_results', 'observed_hour_count',
    ...
    query: `SELECT id, project_id, device_id, period_date, contract_address, measurement_group_id,
      ...
      policy_key, assignment_id, assignment_key, hour_presence, hour_results, observed_hour_count,
      threshold_satisfied, schema_version, circuit_version, status, attempt_count,
