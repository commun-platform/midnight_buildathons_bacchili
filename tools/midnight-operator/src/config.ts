...
export const developmentEnvPath = path.join(repoRoot, 'tools/midnight-operator/.env.development');
...
export const contractArtifactsPath = path.join(
  repoRoot,
  'midnight/contracts/sensor-registry/src/managed/sensor-registry',
);
