  ...
  const response = await deviceAuthenticatedFetch(
    ...
    apiUrl(network.proofServer, '/api/v1/proof-jobs'),
    {
      ...
      body: JSON.stringify({
        ...
        timeZoneOffsetMinutes: attestation.publicData.timeZoneOffsetMinutes,
        localDayStartHour: attestation.publicData.localDayStartHour,
        utcDayStartMinute: attestation.publicData.utcDayStartMinute,
